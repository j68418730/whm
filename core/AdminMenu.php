...
if (!function_exists('admin_menu_sections')) {
    function admin_menu_sections(): array
    {
        return [
            ...
            '📋 ACCOUNT FUNCTIONS' => [
                ['label' => 'Create Account', 'href' => '/admin/account/create', 'icon' => 'bi-person-plus', 'match' => ['/admin/account/create']],
                ['label' => 'List Accounts', 'href' => '/admin/account', 'icon' => 'bi-people', 'match' => ['/admin/account/list', '/admin/account', '/admin/account/show', '/admin/account/edit']],
                ['label' => 'Modify Account', 'href' => '/admin/account', 'icon' => 'bi-pencil-square', 'match' => ['/admin/account/edit', '/admin/account/modify']],
                ['label' => 'Suspend / Unsuspend', 'href' => '/admin/account', 'icon' => 'bi-pause-circle', 'match' => ['/admin/account/suspend', '/admin/account/unsuspend']],
                ['label' => 'Terminate Account', 'href' => '/admin/account', 'icon' => 'bi-x-octagon', 'match' => ['/admin/account/terminate']],
                ['label' => 'Change Password', 'href' => '/admin/account', 'icon' => 'bi-key', 'match' => ['/admin/account/password']],
                ['label' => 'Login as User', 'href' => '/admin/account', 'icon' => 'bi-box-arrow-in-right', 'match' => ['/admin/account/login-as']],
            ],
            '📦 PACKAGES' => [
                ['label' => 'Add Package', 'href' => '/admin/package/create', 'icon' => 'bi-plus-square', 'match' => ['/admin/package/create']],
                ['label' => 'Edit Package', 'href' => '/admin/packages', 'icon' => 'bi-box', 'match' => ['/admin/packages', '/admin/package/edit']],
                ['label' => 'Package Categories', 'href' => '/admin/packages/categories', 'icon' => 'bi-tags', 'match' => ['/admin/packages/categories']],
                ['label' => 'Feature Lists', 'href' => '/admin/feature-lists', 'icon' => 'bi-ui-checks', 'match' => ['/admin/feature-lists']],
                ['label' => 'Reseller Center', 'href' => '/admin/reseller', 'icon' => 'bi-person-workspace', 'match' => ['/admin/reseller']],
            ],
            '🌐 DOMAINS' => [
                ['label' => 'Domains', 'href' => '/admin/domains', 'icon' => 'bi-globe2', 'match' => ['/admin/domains']],
                ['label' => 'DNS Zones', 'href' => '/admin/dns', 'icon' => 'bi-diagram-3', 'match' => ['/admin/dns/list-zones', '/admin/dns']],
                ['label' => 'Nameservers', 'href' => '/admin/dns/nameservers', 'icon' => 'bi-server', 'match' => ['/admin/dns/nameservers']],
            ],
            '🌐 HOSTING SERVICES' => [
                ...
                ['label' => 'FTP Accounts', 'href' => '/admin/ftp', 'icon' => 'bi-upload', 'match' => ['/admin/ftp']],
            ...
            '🖥️ IP MANAGEMENT' => [
                ['label' => 'IP Manager', 'href' => '/admin/ip', 'icon' => 'bi-cpu', 'match' => ['/admin/ip']],
                ['label' => 'Reverse DNS', 'href' => '/admin/dns', 'icon' => 'bi-arrow-return-right', 'match' => ['/admin/dns']],
            ],
            '💳 BILLING' => [
