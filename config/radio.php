    ...
    */
    'servers' => [
        'icecast' => [
            ...
            'default_port' => 6000,
            'admin_port' => 6001,
            'port_range' => '6000-10000',
            'source_password' => env('ICECAST_SOURCE_PASSWORD', bin2hex(random_bytes(8))),
            'admin_password' => env('ICECAST_ADMIN_PASSWORD', bin2hex(random_bytes(8))),
        ],
    ],
