...
('shoutcast', 'SC Mini', '[DEV] Entry-level SHOUTcast streaming.', 0.00, 10, 10, 10, 64, 500, 1, 1, 1, 1),
('shoutcast', 'SC Basic', '[DEV] SHOUTcast for hobby broadcasters.', 0.00, 10, 10, 25, 96, 1, 2, 1, 1, 2),
('shoutcast', 'SC Standard', '[DEV] Community SHOUTcast station.', 0.00, 10, 10, 50, 128, 2, 3, 1, 1, 3),
('shoutcast', 'SC Advanced', '[DEV] Serious SHOUTcast broadcasting.', 0.00, 10, 10, 100, 192, 5, 5, 1, 1, 4),
('shoutcast', 'SC Pro', '[DEV] Professional SHOUTcast station.', 0.00, 10, 10, 250, 256, 10, 10, 1, 1, 5);

-- 6. Seed packages: SHOUTcast Reseller (5 demo, dev-only)
INSERT IGNORE INTO hosting_packages (type, name, description, monthly_price, disk_space, bandwidth, listener_limit, bitrate, storage_limit, dj_accounts, shoutcast_enabled, is_active, sort_order) VALUES
('shoutcast_reseller', 'SC Reseller Mini', '[DEV] Start reselling SHOUTcast.', 0.00, 10, 10, 25, 64, 1, 2, 1, 1, 1),
('shoutcast_reseller', 'SC Reseller Basic', '[DEV] Foundational SHOUTcast reseller.', 0.00, 10, 10, 50, 96, 2, 5, 1, 1, 2),
('shoutcast_reseller', 'SC Reseller Standard', '[DEV] Standard SHOUTcast reseller.', 0.00, 10, 10, 100, 128, 5, 10, 1, 1, 3),
('shoutcast_reseller', 'SC Reseller Advanced', '[DEV] Advanced SHOUTcast reseller.', 0.00, 10, 10, 200, 192, 10, 20, 1, 1, 4),
('shoutcast_reseller', 'SC Reseller Pro', '[DEV] Pro SHOUTcast reseller.', 0.00, 10, 10, 400, 256, 20, 40, 1, 1, 5);
