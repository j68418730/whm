...
$hosts = ["web_hosting" => "🌐 Web Hosting", "icecast" => "📻 Icecast Radio", "game" => "🎮 Game Servers", "reseller" => "🏢 Reseller"];
?><!DOCTYPE html>
<html lang="en">
<head>
...
<div class="feat-grid">
<div class="fcard"><div class="fi">⚡</div><div class="ft">NVMe SSD Storage</div><div class="fd">Lightning-fast NVMe SSD drives for maximum performance</div></div>
<div class="fcard"><div class="fi">🔒</div><div class="ft">Free SSL Certificates</div><div class="fd">Auto-installed Let's Encrypt SSL on all domains</div></div>
<div class="fcard"><div class="fi">🛡️</div><div class="ft">DDoS Protection</div><div class="fd">Advanced mitigation filtering at network edge</div></div>
<div class="fcard"><div class="fi">💾</div><div class="ft">Daily Backups</div><div class="fd">Automated daily backups with 7-day retention</div></div>
<div class="fcard"><div class="fi">📋</div><div class="ft">WHM Control Panel</div><div class="fd">Full account, DNS, email, database management</div></div>
<div class="fcard"><div class="fi">🎧</div><div class="ft">Icecast Radio</div><div class="fd">Built-in SHOUTcast/Icecast streaming support</div></div>
</div></div>
...
?>
<div class="card">
<div class="ico"><?php echo strpos($type,"icecast")!==false ? "📻" : (strpos($type,"game")!==false ? "🎮" : "🌐"); ?></div>
...
<div class="test">"Finally a control panel that does everything. Hosting, radio streaming, billing — it is all here."<div class="au">- Rachel N.</div></div>
