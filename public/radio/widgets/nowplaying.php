...
$online = $stats['status'];
$liveDj = $stats['live_dj'] ? htmlspecialchars($stats['live_dj']) : null;
...
<?php if ($liveDj): ?><div style="font-size:11px;color:#4ade80;font-weight:700;margin-bottom:2px">🔴 LIVE — <?php echo $liveDj; ?></div><?php endif; ?>
