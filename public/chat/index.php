...
<div class="embed-code">&lt;script src="//planet-hosts.com/chatbox/widget.js.php?tenant_id=<?=$tenantId?>"&gt;&lt;/script&gt;</div>
...
function copyEmbed(){
navigator.clipboard.writeText('<script src="//planet-hosts.com/chatbox/widget.js.php?tenant_id=<?=$tenantId?>"><\/script>');
