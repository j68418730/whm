...
// Create demo package
$p->exec("INSERT IGNORE INTO hosting_packages (type, name, description, monthly_price, disk_space, bandwidth, is_active, sort_order) VALUES ('game_server', 'Game Server Demo', 'Try game hosting with a demo server. Enter your own Steam App ID to install any supported game.', 0, 10, 10, 1, 90)");
