...
class GameServersController extends Controller
{
    ...
    public function catalog()
    {
        ...
        return $this->view('Plugins.GameServers.Views.admin.catalog', [
            'user' => $user,
            'games' => $games,
            'title' => 'Game Catalog',
        ]);
    ...
    protected function supportedGames(): array
    {
        return [
            ['name' => 'Counter-Strike 2', 'icon' => '🎯', 'app_id' => 730, 'type' => 'fps', 'note' => 'Competitive FPS servers'],
            ['name' => 'Team Fortress 2', 'icon' => '🔨', 'app_id' => 232250, 'type' => 'fps', 'note' => 'Classic team shooter'],
            ['name' => 'Minecraft', 'icon' => '🧱', 'app_id' => 0, 'type' => 'sandbox', 'note' => 'Vanilla and modded worlds'],
            ['name' => 'Valheim', 'icon' => '⚔️', 'app_id' => 896660, 'type' => 'survival', 'note' => 'Co-op survival hosting'],
            ['name' => 'ARK: Survival Evolved', 'icon' => '🦖', 'app_id' => 376030, 'type' => 'survival', 'note' => 'Creature survival servers'],
            ['name' => 'Rust', 'icon' => '🛠️', 'app_id' => 258550, 'type' => 'survival', 'note' => 'Persistent survival servers'],
            ['name' => 'Demo / Custom', 'icon' => '🎮', 'app_id' => 0, 'type' => 'custom', 'note' => 'Fallback template for any server'],
        ];
    }
}
