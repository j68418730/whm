...
<div class="nav-group"><div class="label">Management</div><a href="/user/files">File Manager</a><a href="/user/databases">Databases</a><a href="/user/usage">Resource Usage</a></div>
