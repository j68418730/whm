...
<?php endif; ?>
<form method="POST" action="/user/login" onsubmit="var u=this.querySelector('[name=email]').value.trim().toLowerCase();if(u==='root'||u==='admin'||u==='kane'){this.action='/admin/login/post'}else{this.action='/user/login'}">
