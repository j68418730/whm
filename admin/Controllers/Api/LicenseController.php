...
class LicenseController extends Controller
{
    ...
    {
        $all = ["accounts","packages","dns","email","ftp","databases","backups","ssl","domains","radio","streams","autodj","shared_hosting","radio_hosting","streaming_icecast","streaming_shoutcast_v1","streaming_shoutcast_v2","streaming_autodj","email_hosting","ftp_hosting","database_hosting","ssl_auto","backups","monitoring","api_access","desktop_app"];
        ...
        switch ($type) {
            ...
            case "full":
            case "lifetime":
                return array_merge($all, ["reseller_hosting","ssl_wildcard","marketplace"]);
