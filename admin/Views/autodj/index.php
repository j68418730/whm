...
<div class="ad-top">
  ...
  <a href="/admin/autodj/schedules">⏰ Schedules</a>
  <a href="/admin/autodj/rules">🔀 Rotation Rules</a>
  <a href="/admin/autodj/metadata">🏷️ Metadata</a>
</div>

<div class="ad-stats">
  <div class="ad-stat"><div class="v blue"><?php echo (int)$autodjStats['total_stations']; ?></div><div class="l">Stations</div></div>
  <div class="ad-stat"><div class="v green"><?php echo (int)$autodjStats['running']; ?></div><div class="l">AutoDJ Running</div></div>
  <div class="ad-stat"><div class="v yellow"><?php echo (int)$autodjStats['total_tracks']; ?></div><div class="l">Total Tracks</div></div>
  <div class="ad-stat"><div class="v purple"><?php echo (int)$autodjStats['total_playlists']; ?></div><div class="l">Playlists</div></div>
</div>
...
<div class="ad-group">
  <div class="gh">
    ...
    <div class="gmeta">
      ...
      <?php echo array_sum(array_map(fn($s) => (int)$s->track_count, $userStations)); ?> tracks ·
      <?php echo count(array_filter($userStations, fn($s) => $s->autodj_running)); ?> running
    </div>
  </div>
  <div class="ad-cards">
    ...
    <div class="ad-card">
      <div class="row1">
        ...
        <span class="ad-badge <?php echo $s->autodj_running ? 'running' : 'stopped'; ?>"><?php echo $s->autodj_running ? '● Running' : '○ Stopped'; ?></span>
      </div>
      ...
      <div class="meta">
        <span>🎵 <b><?php echo (int)$s->track_count; ?></b></span>
        <span>📋 <b><?php echo (int)$s->playlist_count; ?></b></span>
        <span>📻 <b><?php echo (int)$s->listener_count; ?></b></span>
        <span>🎧 <b><?php echo (int)$s->bitrate; ?>kbps</b></span>
      </div>
      <div class="meta">Now: <b><?php echo htmlspecialchars($s->current_song ?: '—'); ?></b></div>
      <div class="acts">
        <a class="start" href="/user/radio/autodj/start/<?php echo 10000 + (int)$s->id; ?>" <?php if ($s->autodj_running): ?>style="opacity:.4;pointer-events:none"<?php endif; ?>>▶ Start</a>
        <a class="stop" href="/user/radio/autodj/stop/<?php echo 10000 + (int)$s->id; ?>" <?php if (!$s->autodj_running): ?>style="opacity:.4;pointer-events:none"<?php endif; ?>>⏹ Stop</a>
