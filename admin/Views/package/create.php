...
<div style="background:rgba(248,113,113,.1);border:1px solid rgba(248,113,113,.2);border-radius:8px;color:#f87171;font-size:13px;padding:12px;margin-bottom:16px"><i class="fa-solid fa-circle-exclamation"></i> <?php echo htmlspecialchars($_SESSION['error_message'], ENT_QUOTES, 'UTF-8'); unset($_SESSION['error_message']); ?></div>
<?php endif; ?>
<form method="POST" action="/admin/package/create">
<?php echo $csrfField ?? ''; ?>
<?php
$package = (object)[
    'id' => 0, 'name' => '', 'type' => 'web_hosting',
    'disk_space' => 0, 'bandwidth' => 0, 'max_domains' => 1, 'max_subdomains' => 0,
    'email_accounts' => 5, 'ftp_accounts' => 5, 'databases' => 5, 'parked_domains' => 0, 'addon_domains' => 0,
    'feature_list_id' => '', 'php_version' => '8.2', 'has_software' => 0,
    'listener_limit' => 0, 'bitrate' => 0, 'dj_accounts' => 0, 'is_active' => 1, 'features' => [],
    'streaming_package' => [], 'game_package' => [],
];
...
?>
<div class="row">
<div class="form-group"><label>Name</label><input name="name" value="<?php echo htmlspecialchars($package->name ?? '', ENT_QUOTES, 'UTF-8'); ?>" required placeholder="e.g. Starter, Basic, Business, Pro"></div>
