...
<h3 style="color:var(--accent);margin-bottom:16px">Package Categories</h3>
...
<td><?php echo $cat->sort_order ?? 0; ?></td>
<td><a href="/admin/packages/categories/delete/<?php echo $cat->id; ?>" class="btn btn-sm" style="background:rgba(255,50,50,.15);color:#ff6b6b;border:1px solid rgba(255,50,50,.2)" onclick="return confirm('Delete this category?')">Delete</a></td>
</tr>
<?php endforeach; else: ?>
