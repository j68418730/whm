...
<a href="/phpmyadmin/" target="_blank" style="display:inline-block;padding:14px 40px;background:linear-gradient(135deg,#008cff,#3bb8ff);color:#fff;border-radius:10px;text-decoration:none;font-weight:700;font-size:16px">Open phpMyAdmin</a>
</div>

<div class="card" style="margin-top:16px">
<h3 style="color:var(--accent);margin-bottom:8px">Database Access</h3>
<p style="color:var(--text-secondary);margin-top:8px;font-size:13px">Each hosting account has its own database credentials. Use phpMyAdmin above to manage databases directly with root access (no login prompt).</p>
</div>
</div>