...
<h3 style="color:var(--accent);margin-bottom:8px">Databases</h3>
<p style="color:var(--text-secondary);font-size:13px">MySQL stats & database overview</p>
</div>

<div class="card" style="margin-top:16px">
<h3 style="color:var(--accent);margin-bottom:8px">Database Access</h3>
<p style="color:var(--text-secondary);margin-top:8px;font-size:13px">Each hosting account has its own database credentials. Database management is available through the panel.</p>
</div>
</div>