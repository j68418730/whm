...
<form method="POST" action="/admin/marketplace/install/<?php echo $app->id; ?>" style="display:flex;gap:6px;flex-wrap:wrap;justify-content:center">
<input name="username" value="<?php echo 'app_' . strtolower(preg_replace('/[^a-zA-Z0-9]/', '', $app->name)); ?>" style="width:100%;padding:6px;border-radius:6px;border:1px solid rgba(255,255,255,.1);background:rgba(255,255,255,.04);color:#fff;font-size:11px;text-align:center;outline:none">
