...
.term-screen{background:#0d1117;padding:10px 14px;min-height:360px;max-height:60vh;overflow:auto}
...
<p style="color:#64748b;font-size:13px;margin-bottom:16px">A real PTY shell running as <strong><?php echo htmlspecialchars($hosting->username ?? 'your account'); ?></strong>. You are restricted to your own account (Linux enforces it — you cannot read other customers' files or system secrets).</p>
</div>
<div class="term-wrap">
<div class="term-bar">
...
<div class="term-hint">Click inside and type. Ctrl+C, arrows, Tab, interactive apps supported. You start in your home directory.</div>
</div>

<script>
(function(){
var base = '/user/terminal';
