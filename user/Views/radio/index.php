...
function copyDjInfo(){
  ...
  <form method="post" action="/user/radio/dj/create">
    ...
    <!-- Multi-Station Assignment: new DJs auto-assigned to ALL stations -->
    <div style="margin-top:16px;padding:16px;background:rgba(251,146,60,.08);border:1px solid rgba(251,146,60,.2);border-radius:8px">
      ...
      <p style="font-size:12px;color:var(--text-muted);margin-bottom:12px">New DJs are automatically assigned to <strong>all</strong> stations on your account (Icecast, SHOUTcast v1 &amp; v2). You can change this later via Edit.</p>
      <div style="display:grid;grid-template-columns:repeat(auto-fill,minmax(180px,1fr));gap:8px">
        ...
        <label style="display:flex;align-items:center;gap:8px;padding:8px;background:rgba(0,0,0,.2);border:1px solid rgba(255,255,255,.08);border-radius:6px;cursor:pointer;font-size:13px;color:#e0e0e0;transition:all .15s">
          <input type="checkbox" name="station_ids[]" value="<?php echo $st->id; ?>" <?php echo $checked ?> <?php echo $disabled ?> style="margin:0;transform:scale(1.1)">
