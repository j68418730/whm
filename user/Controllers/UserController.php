...
class UserController extends Controller
{
    ...
    public function publicDjs() { $u = $this->loadUser(); $allDjs = []; try { $allDjs = $this->db->table('radio_djs')->where('status', 'active')->orderBy('name', 'ASC')->get() ?: []; } catch(\Exception $e) {} return $this->view('user.public_djs', ['user' => $u, 'hosting' => $this->hostingUser, 'allDjs' => $allDjs, 'title' => 'Our DJs']); }
