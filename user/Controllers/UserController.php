...
class UserController extends Controller
{
    ...
    public function djPanel() { $u = $this->loadUser(); $streams = []; if ($this->hostingUser) { try { $streams = $this->db->table('radio_streams')->where('user_id', $this->hostingUser->id)->get() ?: []; } catch(\Exception $e) {} } return $this->view('user.dj_dashboard', ['user' => $u, 'hosting' => $this->hostingUser, 'streams' => $streams, 'title' => 'DJ Panel']); }
