...
$router->get('/product/{id}', 'Admin\Controllers\AuthController@productPage');
...
$router->get('/admin/files', 'Admin\Controllers\FilesystemController@fileManager');
$router->get('/admin/files/list', 'Admin\Controllers\FilesystemController@listFiles');
$router->get('/admin/files/read', 'Admin\Controllers\FilesystemController@readFile');
$router->post('/admin/files/save', 'Admin\Controllers\FilesystemController@saveFile');
$router->get('/admin/files/delete', 'Admin\Controllers\FilesystemController@deleteFile');
$router->get('/admin/files/download', 'Admin\Controllers\FilesystemController@downloadFile');
$router->post('/admin/files/mkdir', 'Admin\Controllers\FilesystemController@makeDir');
$router->post('/admin/files/rename', 'Admin\Controllers\FilesystemController@renameFile');
$router->post('/admin/files/copy', 'Admin\Controllers\FilesystemController@copyFile');
$router->post('/admin/files/move', 'Admin\Controllers\FilesystemController@moveFile');
$router->get('/admin/files/property', 'Admin\Controllers\FilesystemController@property');
$router->post('/admin/files/chmod', 'Admin\Controllers\FilesystemController@chmod');
$router->get('/admin/files/search', 'Admin\Controllers\FilesystemController@search');
...
$router->get('/admin/update/log', 'Admin\Controllers\UpdateController@log');
$router->get('/admin/settings/update', 'Admin\Controllers\SettingsController@update');
...
$router->get('/api/search', 'Admin\Controllers\Api\DesktopController@search');
$router->get('/api/chats/visitors', 'Admin\Controllers\Api\DesktopController@visitors');
$router->get('/api/chats', 'Admin\Controllers\Api\DesktopController@listChats');
$router->get('/api/chats/{id}/messages', 'Admin\Controllers\Api\DesktopController@getChatMessages');
$router->post('/api/chats/{id}/message', 'Admin\Controllers\Api\DesktopController@sendChatMessage');
$router->post('/api/chats/{id}/close', 'Admin\Controllers\Api\DesktopController@closeChat');
$router->post('/api/chats/{id}/transfer', 'Admin\Controllers\Api\DesktopController@transferChat');
$router->get('/api/v1/accounts', 'Admin\Controllers\Api\DesktopController@listAccounts');
$router->get('/api/v1/accounts/{id}', 'Admin\Controllers\Api\DesktopController@getAccount');
$router->put('/api/v1/accounts/{id}', 'Admin\Controllers\Api\DesktopController@updateAccount');
$router->post('/api/v1/accounts/{id}/suspend', 'Admin\Controllers\Api\DesktopController@suspendAccount');
$router->post('/api/v1/accounts/{id}/unsuspend', 'Admin\Controllers\Api\DesktopController@unsuspendAccount');
$router->post('/api/v1/accounts/{id}/reset-password', 'Admin\Controllers\Api\DesktopController@resetPassword');
$router->get('/api/v1/accounts/{id}/hosting', 'Admin\Controllers\Api\DesktopController@getAccountHosting');
$router->get('/api/v1/accounts/{id}/streams', 'Admin\Controllers\Api\DesktopController@getAccountStreaming');
$router->get('/api/v1/accounts/{id}/login-history', 'Admin\Controllers\Api\DesktopController@getAccountLoginHistory');
$router->get('/api/v1/accounts/{id}/sessions', 'Admin\Controllers\Api\DesktopController@getAccountSessions');
$router->get('/api/v1/accounts/{id}/notes', 'Admin\Controllers\Api\DesktopController@getAccountNotes');
$router->post('/api/v1/accounts/{id}/notes', 'Admin\Controllers\Api\DesktopController@addAccountNote');
$router->get('/api/v1/tickets', 'Admin\Controllers\Api\DesktopController@listTickets');
$router->get('/api/v1/tickets/{id}', 'Admin\Controllers\Api\DesktopController@getTicket');
$router->get('/api/v1/tickets/{id}/messages', 'Admin\Controllers\Api\DesktopController@getTicketMessages');
$router->post('/api/v1/tickets/{id}/reply', 'Admin\Controllers\Api\DesktopController@replyTicket');
$router->post('/api/v1/tickets/{id}/close', 'Admin\Controllers\Api\DesktopController@closeTicket');
$router->get('/api/v1/invoices', 'Admin\Controllers\Api\DesktopController@listInvoices');
$router->get('/api/v1/orders', 'Admin\Controllers\Api\DesktopController@listOrders');
$router->get('/api/v1/transactions', 'Admin\Controllers\Api\DesktopController@listTransactions');
...
$router->post('/api/remote/request', 'Admin\Controllers\Api\DesktopController@requestRemote');
...
$router->post('/api/requests/action', 'Admin\Controllers\Api\PlanetStudioController@requestAction');
...
$router->get('/storefront', 'Admin\Controllers\BillingController@store');
$router->get('/storefront/theme.css', 'Admin\Controllers\BillingController@storeThemeCss');
$router->get('/storefront/embed.js', 'Admin\Controllers\BillingController@storeEmbedJs');
