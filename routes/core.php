...
$router->post('/admin/migration/preflight', 'Admin\Controllers\MigrationController@preflight');
$router->post('/admin/migration/save-package-map', 'Admin\Controllers\MigrationController@savePackageMap');
$router->get('/admin/migration/get-preflight', 'Admin\Controllers\MigrationController@getPreflight');
