...
$router->get('/user/radio/dj-panel', 'User\Controllers\DjPanelController@index');
$router->get('/user/radio/dj-panel/djs', 'User\Controllers\DjPanelController@djs');
$router->post('/user/radio/dj-panel/djs/create', 'User\Controllers\DjPanelController@createDj');
$router->get('/user/radio/dj-panel/djs/delete/{id}', 'User\Controllers\DjPanelController@deleteDj');
$router->get('/user/radio/dj-panel/schedule', 'User\Controllers\DjPanelController@schedule');
$router->post('/user/radio/dj-panel/schedule/add', 'User\Controllers\DjPanelController@addSchedule');
$router->get('/user/radio/dj-panel/schedule/delete/{id}', 'User\Controllers\DjPanelController@deleteSchedule');
$router->get('/user/radio/dj-panel/requests', 'User\Controllers\DjPanelController@requests');
$router->get('/user/radio/dj-panel/requests/delete/{id}', 'User\Controllers\DjPanelController@deleteRequest');
$router->get('/user/radio/dj-panel/settings', 'User\Controllers\DjPanelController@settings');
$router->post('/user/radio/dj-panel/settings/save', 'User\Controllers\DjPanelController@saveSettings');
$router->get('/user/radio/dj-panel/artists', 'User\Controllers\DjPanelController@artists');
$router->post('/user/radio/dj-panel/artists/add', 'User\Controllers\DjPanelController@addArtist');
$router->get('/user/radio/dj-panel/artists/delete/{id}', 'User\Controllers\DjPanelController@deleteArtist');
$router->get('/user/radio/dj-panel/ads', 'User\Controllers\DjPanelController@ads');
$router->post('/user/radio/dj-panel/ads/create', 'User\Controllers\DjPanelController@createAd');
$router->get('/user/radio/dj-panel/ads/delete/{id}', 'User\Controllers\DjPanelController@deleteAd');
